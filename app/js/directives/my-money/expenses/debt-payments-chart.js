    ...
    link = function(scope, element, attrs) {
       $q.all([
        ...
        .then(function(response){
          ...
          console.log("getDebtAndPolicyPayments", debtsAndPolicyPayments);
          scope.totalDebt = _.detect(debtsAndPolicyPayments, function(item){return item.kind =="debt"}).total_amount;
          scope.totalDebtPercent = Math.round(10000.0 * scope.totalDebt / totalExpenses)/100;
       });
    };
