(function() {
  'use strict';
  angular.module('agera').controller('TimelineDashboardCtrl', function(Person,$scope, $modal, $filter, $rootScope, $location, $timeout, $cacheFactory, goalService, Action, Scenario, CashfinderService, ENV, ProfileItem) {
