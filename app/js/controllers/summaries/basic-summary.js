(function () {
  ...
  //angular.module('summaries').controller('ringSummaryCtrl', function ($scope, $location, $routeParams, RingSummary) {
  //  var getNeed = function (current, target) {
  //    var amt;
  //    amt = target - current;
  //    return Math.max(amt, 0);
  ...
  //angular.module('summaries').controller('travelSummaryCtrl', function ($scope, $location, $routeParams, TravelSummary) {
  //  var getNeed = function (current, target) {
  //    var amt;
  //    amt = target - current;
  //    return Math.max(amt, 0);
  ...
  //angular.module('summaries').controller('purchaseSummaryCtrl', function ($scope, $location, $routeParams, PurchaseSummary) {
  //  var getNeed = function (current, target) {
  //    var amt;
  //    amt = target - current;
  //    return Math.max(amt, 0);
  ...
  //angular.module('summaries').controller('weddingSummaryCtrl', function ($scope, $location, $routeParams, WeddingSummary) {
  //  var getNeed = function (current, target) {
  //    var amt;
  //    amt = target - current;
  //    return Math.max(amt, 0);
