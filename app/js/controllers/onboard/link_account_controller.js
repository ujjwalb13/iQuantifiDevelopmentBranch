(function() {
  ...
  angular.module('aggregation').controller('OnboardLinkAccountCtrl', function(onboarding, $scope, $rootScope, $routeParams, $http, $q, $location, $window, poller, Institution, Member, Job, ENV, welcomeTextService) {
    ...
    $scope.credentials = Institution.credentials({
      id: $scope.institution.guid
    });
    $scope.credentialValues = {
      institution_guid: $scope.institution.guid,
      credentials: {}
    };
...
//# sourceMappingURL=link_account_controller.js.map
